...
public class AddServer {
    ...
    public static final int PORT_NO = 8887;
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        while (true) {
            Socket addsocket2 = serverSocket.accept(); 
            ...
            if (line.trim().startsWith("quit")) {
                ...
                processRequest(addsocket2, line);
            }
        }
    ...
    private static void processRequest(Socket addsocket2, String line) throws IOException, InterruptedException {
        PrintWriter pw = new PrintWriter(addsocket2.getOutputStream());
