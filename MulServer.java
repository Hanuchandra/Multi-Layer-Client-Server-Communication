...
public class MulServer {
    ...
    public static final int PORT_NO = 8890;
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        while (true) {
            Socket mulsocket = serverSocket.accept(); 
    ...
    private static void processRequest(Socket mulsocket, String line) throws IOException, InterruptedException {
